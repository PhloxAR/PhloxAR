...
class OBJ(object):
    ...
    def __init__(self, filename, file=None, path=None):
        ...
        self.transforms = math3d.Matrix4.new_identity()
    ...
    def rotate(self, angle, x, y, z):
        self.transforms.rotate_axis(math.pi*angle/180.0, math3d.Vector3(x, y, z))
        ...
        for mesh in self.mesh_list:
            for group in mesh.groups:
                ...
                for index in range(0, len(group.vertices), 3):
                    tv = self.transforms * math3d.Point3(group.vertices[index],
                                                         group.vertices[index+1],
                                                         group.vertices[index+2])
                    vertices.extend(tv[:])
                    tn = self.transforms * math3d.Point3(group.normals[index],
